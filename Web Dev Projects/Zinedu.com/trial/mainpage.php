...
<div id="outer">
	...
	<div id="menu">
		...
		$result=mysql_query("SELECT topic from topics order by Date desc limit 0,4",$link_id);
		$x=0;
		while($x < mysql_numrows($result))
		{
			...
			$x++;
		?>
	   <a href="sub.php?topic=<?php echo $topic; ?>" style="text-decoration:none;" > <?php echo $topic; ?> </a><br/><br/>
     <?php
    }
    ?>
